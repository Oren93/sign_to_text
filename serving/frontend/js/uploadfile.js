...
const millisecondsBatch = 1000
const API_URL = 'http://localhost:8000'
const PROCESS_RATE = 10; // Example processing rate, TODO: user adjusts in the UI
...
document.getElementById('uploadForm').addEventListener('submit', function(event) {
    ...
    .then(data => {
        ...
        confidence = (data.confidence_level * 100).toFixed(2) + '%'
        ...
        newRow.insertCell(2).appendChild(document.createTextNode(confidence));

        var responsesDiv = document.getElementById('response');
